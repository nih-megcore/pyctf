# Test multisphere forward solution.
...
def test_multi():
    ...
    print("SAMsolve")
    wc, s2, n2 = _samlib.SAMsolve(c, cinv, Bc, 1.)
    print(s2, n2)
    wu, s2, n2 = _samlib.SAMsolve(c, cinv, Bu, 1.)
    print(s2, n2)

    np.save("/tmp/wc", wc)
    np.save("/tmp/wu", wu)

    return Bc, Bu, v, cond, wc, wu
