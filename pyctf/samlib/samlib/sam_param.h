...
typedef struct {
    ...
    //double      PropMu;             // regularization as a multiplier for sigma^2 * I
    ...
    double      InitTrans;          // initial translation step-size (m)
    double      InitRotat;          // initial rotation step-size (rad)
    double      EndTrans;           // stopping translation step-size (m)
    double      EndRotat;           // stopping rotation step-size (rad)
