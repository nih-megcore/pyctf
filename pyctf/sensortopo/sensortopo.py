...
class sensortopo:
    ...
    def plot(self, z, cmap = None, zrange = 'zero', label = False, showsens = False, nocontour = False):
        ...
        # The default cmap depends on which version of pylab we're using.

        if cmap is None:
            if hasattr(cm, 'coolwarm'):
                cmap = cm.coolwarm
            else:
                cmap = cm.jet
